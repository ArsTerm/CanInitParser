...
// 1 кнуц = 46 мА (1А =21.76 кнуц)
//ток CAN шины
// 1 кнуц = 4.4 мА (1А =227 кнуц)
//токи в нагрузках платы МСИрбис
// 1 кнуц = 37.65 мА (1А =26.5625 кнуц)
//токи в нагрузках платы Тыл20
// 1 кнуц =  30.33мА (1А =32.97 кнуц)
//напряжение аккумулятора из ирбиса
// 1 кнуц = 1.375 мВ (1В = 727.27кнуц)(мах 45В)
//ток аккумулятора из КВП
// 1 кнуц = 22.89 мА (1А =43.69 кнуц)(+-375А)
//ток аккумулятора из Тыла
// 1 кнуц = 15.1 мА (1А =66.2 кнуц)(+-247А)
//ток собственных нужд из КВП
// 1 кнуц = 7.63 мА (1А =131.072 кнуц)(+-125А)
//-----------------------------------------
...
//----------------------------------------------------------------------------------
#define Speed_LH can_mes.can_mes_int[8][0] // @*sign = signed*@
...
#define cnt_9_st can_cnt[238] // @*type = cnt*@
/******************************************************************/
